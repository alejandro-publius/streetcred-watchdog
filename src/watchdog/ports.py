...
class Actuator(Protocol):
    ...
    async def regenerate_letter(self, corner: dict[str, Any], counts: Counts, delta: Delta, reasoning: str) -> str: ...

    async def reaudit_imagery(self, corner: dict[str, Any], counts: Counts, delta: Delta, reasoning: str) -> str: ...
